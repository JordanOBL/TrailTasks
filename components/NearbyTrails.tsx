...
const NearbyTrails = ({sectionTitle}: Props) => {
  ...
  const {trails, setTrails} = getTrails();
              ...
              <View
                ...
                <View style={{marginTop: 10, padding: 5}}>
                  <Text
                    ...
                    {CapitalizeDifficulty(trail.trail_difficulty)}
                  </Text>
                  ...
                  <View style={{position: 'relative'}}>
                        ...
                        <Pressable
                          onPress={() =>
                            onDeleteFromQueueClick({
                              ...
                              selected_trail_id: trail.trail_id,
                          ...
                          <Text
                            style={[
                              styles.QueueButtons,
                              {
                                color: !trail.queued ? 'rgb(7,254,213)' : 'red',
                              },
                            ]}>
                            -
                          </Text>
                    ...
                    <Pressable
                      style={{
                        backgroundColor:
                          user.current_trail_id == trail.trail_id
                            ? 'gray'
                            : 'rgb(7,254,213)',
                        width: '50%',
                        borderRadius: 10,
                      ...
                      onPress={() =>
                        startNowClick({
                          selected_trail_id: trail.trail_id,
                          current_trail_id: user.trail_id,
                          setUser: setUser,
                          watermelonDatabase,
                          user,
                          setReplacementCurrentTrailId,
                      ...
                      disabled={user.current_trail_id == trail.trail_id}>
                      <Text
                        style={{
                          color: 'rgb(31,33,35)',
                          fontWeight: 'bold',
