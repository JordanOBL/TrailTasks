...
const SoloResultsScreen = ({ rewards, snapshot, resetSession }: Props) => {
  ...
  if (!rewards || !snapshot) {
    return (
      <View>
        <Text> Unable to load session rewards...</Text>
      </View>
    );
  }
    ...
    <View style={styles.container} testID="session-results-screen">
      ...
      <View style={styles.sessionSummary}>
        <Text style={styles.summaryText}>
          Total Time:{" "}
          <Text testID="total-time-text" style={styles.value}>
            {formatTime(snapshot?.totalElapsedSec)}
          </Text>
        </Text>
        <Text style={styles.summaryText}>
          Total Distance:{" "}
          <Text testID="total-distance-text" style={styles.value}>
            {`${snapshot?.totalDistanceMiles} miles`}
          </Text>
        </Text>
        <Text style={styles.summaryText}>
          Sets Completed:{" "}
          <Text testID="sets-completed-text" style={styles.value}>
      ...
      <View style={styles.sessionSummary}>
        <Text style={styles.summaryText}>
          Trail Tokens:{" "}
          <Text testID="trail-tokens-earned-text" style={styles.value}>
            {rewards.trailRewards}
          </Text>
        </Text>
        <Text style={styles.summaryText}>
          Time Tokens:{" "}
          <Text testID="time-tokens-earned-text" style={styles.value}>
            {rewards.timeRewards}
          </Text>
        </Text>
        <Text style={styles.summaryText}>
          Total Tokens Earned:{" "}
          <Text testID="total-tokens-earned-text" style={styles.value}>
            {rewards.totalTokenRewards}
          </Text>
        </Text>
      </View>
