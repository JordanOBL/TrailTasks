...
describe.skip('ActiveSession', () => {
  // TODO: Re-enable under follow-up ticket after test DB setup is repaired.
  ...
  const TestWrapper = () => {
    ...
    async function handleShowResultsScreen() {
      const sessionTokensReward = await Rewards.calculateSessionTokens({
        setSessionDetails,
        sessionDetails,
        timer,
      });
